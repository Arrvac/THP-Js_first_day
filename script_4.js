const entrepreneurs = [
    ...
    let sortLast = entrepreneurs.sort(function(a, b) {
      ...
      // array born in seventies
      console.log(entrepreneur_array(entrepreneurs));
      //name:
      console.log(entrepreneurs.map(getFullName));
      //age
      console.log(entrepreneurs.map(getAge));
      //sort
